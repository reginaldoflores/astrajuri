        ...
        <div class="animate form login_form">
          <section class="login_content">
			...
			<div>
				...
				competitivo quanto o de advocacia, priorizar o bom atendimento ao cliente é um diferencial. ASTRAJURI agiliza a 
				gestão do escritório controlando dos prazos, dos processos, dos documentos e finanças. Tudo é feito ao mesmo tempo 
				e as informações são armazenadas em apenas um único lugar. Tornando-se uma ferramenta ágil, produtiva e que pode ser 
				acessada de qualquer lugar e com um banco de dados inteligente preparado para atender as necessidades do público alvo.</p>
            </div>
