...
INSERT INTO `advogado` VALUES (1,'12345',3);
...
CREATE TABLE `processo` (
  ...
  CONSTRAINT `CComarca` FOREIGN KEY (`idVara`) REFERENCES `comarca` (`idComarca`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `processo` VALUES (6,'00653715320128190205','Reginaldo Moro','Vinicius Lima e Cruz','Walter Lemos',1,6,NULL,2,1,1,NULL),(7,'13151848438438434844','1','Dirceu','1',1,6,NULL,2,3,1,NULL),(8,'12513513543484383844','Cicrano','Fulano','Braz de Pinha',1,6,NULL,2,1,1,NULL),(10,'31351385438438643846','Juiz teste','Advogado teste','Teste',1,22,NULL,2,1,1,NULL),(11,'5213513513543843','Juiz novo teste','Advoagdo Novo teste','Teste Novo',1,22,NULL,2,3,1,NULL);
...
-- Dump completed on 2018-09-09 17:40:48
