...
-- Copiando dados para a tabela mydb.comarca: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `comarca` DISABLE KEYS */;
INSERT IGNORE INTO `comarca` (`idComarca`, `Nome`, `Endereco`) VALUES
...
-- Copiando dados para a tabela mydb.contato: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `contato` DISABLE KEYS */;
INSERT IGNORE INTO `contato` (`idContato`, `Email`, `idEndereco`) VALUES
	(2, 'admin@mail.com', 1),
	(3, 'carlos@gmail.com', 2),
...
-- Copiando dados para a tabela mydb.endereco: ~5 rows (aproximadamente)
...
INSERT IGNORE INTO `endereco` (`idEndereco`, `UF`, `CEP`, `Logradouro`, `Numero`, `Cidade`, `Bairro`, `Complemento`, `Estado`) VALUES
	...
	(2, 'RJ', '26129986', 'rua tal tal', 179, 'Rio de Janeiro', 'Realengo', 'Fundo', NULL),
	(4, 'RJ', '26180-290', 'Rua Avenida', 90, 'Rio de Janeiro', 'Deodoro', 'Qd 22', NULL),
	(5, 'RJ', '12345-123', 'Rua 123', 123, 'Rio de Janeiro', 'Deodoro', 'Esquina', NULL),
	(6, 'RJ', '15189120', 'Rua Do Ipiranga', 998, 'Rio de Janeiro', 'Madureira', 'Morro Brabo', NULL);
...
-- Copiando dados para a tabela mydb.pessoa_fisica: ~4 rows (aproximadamente)
...
INSERT IGNORE INTO `pessoa_fisica` (`idPessoa_Fisica`, `CPF`, `Nome`, `Data_Nasc`, `CNH`, `Titulo de Eleitor`, `RG`, `Contato_idContato`) VALUES
	...
	(3, '12309845612', 'Carlos Eduardo', '2018-08-15', NULL, NULL, 129086731, 3),
	(6, '12390789112', 'Walter Silva', '2018-08-15', NULL, NULL, 123987891, 5);
...
-- Copiando dados para a tabela mydb.telefone: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `telefone` DISABLE KEYS */;
INSERT IGNORE INTO `telefone` (`idTelefone`, `Celular`, `Residencial`, `Comercial`, `Contato_idContato`) VALUES
	(1, '', '21 928389318', NULL, 2),
	(2, '', '(21)2728-2829', NULL, 3),
	(5, '', '2190902190', NULL, 5);
